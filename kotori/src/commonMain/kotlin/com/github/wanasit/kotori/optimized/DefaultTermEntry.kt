...
data class DefaultTermEntry(
    ...
    companion object {
        ...
        fun readFromInputStream(inputStream: Source) : Array<DefaultTermEntry> {
        ...
        fun writeToOutputAsDefaultTermEntries(outputStream: Sink, termEntries: Array<TermEntry<DefaultTermFeatures>>) {
            writeToOutput(outputStream, termEntries.map { copy(it) }.toTypedArray() )
        }

        fun writeToOutput(outputStream: Sink, termEntries: Array<DefaultTermEntry>) {
