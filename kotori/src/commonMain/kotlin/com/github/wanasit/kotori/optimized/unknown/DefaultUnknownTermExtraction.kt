...
object DefaultUnknownTermExtraction {
    ...
    fun readFromInputStream(
            inputStream: Source): UnknownTermExtractionByCharacterCategory<DefaultTermFeatures>? {
    ...
    fun writeToOutputStream(outputStream: Sink, value: UnknownTermExtractionByCharacterCategory<DefaultTermFeatures>?) {
        if (value == null) {
